...
- Main Dashboard: `docs/ui/screenshots/dashboard-main.txt`
- Portfolio Grid - Assets Tab: `docs/ui/screenshots/grid-assets.txt`
- Portfolio Grid - Strategies + Config Popup: `docs/ui/screenshots/grid-strategies-config.txt`
- Portfolio Grid - Network Tab: `docs/ui/screenshots/grid-network.txt`
