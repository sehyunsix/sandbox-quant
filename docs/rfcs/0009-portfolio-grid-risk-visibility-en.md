# RFC 0009: Portfolio Grid Risk Visibility (English Edition)

- Status: Draft
- Language: English
- Source: 0009-portfolio-grid-risk-visibility.md

## 1. Context
This is the English edition for RFC 0009. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0009-portfolio-grid-risk-visibility.md
