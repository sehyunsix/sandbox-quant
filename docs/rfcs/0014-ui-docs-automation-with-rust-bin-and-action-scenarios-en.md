# RFC 0014: Ui Docs Automation With Rust Bin And Action Scenarios (English Edition)

- Status: Draft
- Language: English
- Source: 0014-ui-docs-automation-with-rust-bin-and-action-scenarios.md

## 1. Context
This is the English edition for RFC 0014. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0014-ui-docs-automation-with-rust-bin-and-action-scenarios.md
