# RFC 0011: Portfolio Grid Three Tab Separation (English Edition)

- Status: Draft
- Language: English
- Source: 0011-portfolio-grid-three-tab-separation.md

## 1. Context
This is the English edition for RFC 0011. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0011-portfolio-grid-three-tab-separation.md
