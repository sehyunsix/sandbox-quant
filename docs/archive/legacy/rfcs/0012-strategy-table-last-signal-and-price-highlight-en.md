# RFC 0012: Strategy Table Last Signal And Price Highlight (English Edition)

- Status: Draft
- Language: English
- Source: 0012-strategy-table-last-signal-and-price-highlight.md

## 1. Context
This is the English edition for RFC 0012. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0012-strategy-table-last-signal-and-price-highlight.md
