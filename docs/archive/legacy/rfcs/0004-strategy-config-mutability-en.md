# RFC 0004: Strategy Config Mutability (English Edition)

- Status: Draft
- Language: English
- Source: 0004-strategy-config-mutability.md

## 1. Context
This is the English edition for RFC 0004. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0004-strategy-config-mutability.md
