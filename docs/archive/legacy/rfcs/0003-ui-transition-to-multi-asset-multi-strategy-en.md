# RFC 0003: Ui Transition To Multi Asset Multi Strategy (English Edition)

- Status: Draft
- Language: English
- Source: 0003-ui-transition-to-multi-asset-multi-strategy.md

## 1. Context
This is the English edition for RFC 0003. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0003-ui-transition-to-multi-asset-multi-strategy.md
