# RFC 0010: Portfolio Grid Chart Layering And Shortcut Separation (English Edition)

- Status: Draft
- Language: English
- Source: 0010-portfolio-grid-chart-layering-and-shortcut-separation.md

## 1. Context
This is the English edition for RFC 0010. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0010-portfolio-grid-chart-layering-and-shortcut-separation.md
