# RFC 0008: Bottom Keybind Bar Simplification (English Edition)

- Status: Draft
- Language: English
- Source: 0008-bottom-keybind-bar-simplification.md

## 1. Context
This is the English edition for RFC 0008. It keeps the same scope and decision intent as the source RFC.
...
## 9. Notes
For full domain-specific details, examples, and rationale, see: 0008-bottom-keybind-bar-simplification.md
