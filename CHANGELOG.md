...
- Align crate metadata with current runtime (2474013)
- Delete legacy data and archive remaining UI docs (3955715)
- Archive legacy docs and remove dead UI code (bed4f83)
- Refresh portfolio before execution commands (73f66e2)
- Validate order quantity before submit (daa6ffa)
- Surface exchange submit error details (0bd1162)
- Support flat target exposure and symbol completion (57229f8)
- Use filtered counts in portfolio summary (02e165b)
- Filter flat positions from portfolio output (13e91a5)
- Render refresh output as portfolio summary (9ab05fa)
- Print shell output line by line at column zero (cf7e02d)
- Reset shell output to column zero (6111d4a)
- Move shell cursor up with completion scroll (4afd41f)
- Scroll shell completions near terminal bottom (4a5dee1)
- Clear completion menu before shell output (db87376)
- Show described shell completions (da0334a)
- Support arrow navigation in shell completions (486fa66)
- Keep shell alive on errors and auto-show completions (f4bea14)
- Render shell completions as mini menu (a494e5c)
- Show runtime status in shell prompt (c0eef6d)
- Polish interactive shell prompt and completions (7b5425c)
- Add live Binance integration test path (1d256cb)
- Add integration test for auth error surfacing (44104f7)
- Add demo mode switching and shell completion (cf1d502)
- Add detailed Binance authentication errors (81edfcd)
- Add interactive shell command mode (21e5ea0)
- Update env example for current runtime (ecda708)
- Rewrite README for current v1 runtime (2fe1b44)
- Render detailed execution summaries (34c1abe)
- Render CLI summaries for runtime commands (9851184)
- Fetch execution prices through exchange facade (3b37bbe)
- Add CLI parsing for execution commands (d99b74b)
- Add runnable app entrypoint (6fd6272)
- Add env bootstrap for Binance app runtime (2c456ab)
- Implement signed Binance HTTP transport (69a6405)
- Add app runtime orchestration (42823d4)
- Generalize event logging payloads (8de8cc0)
- Log execution outcomes through event records (9c96027)
- Add unified execution command dispatch (841f2af)
- Wire target exposure planning to order submission (1b03358)
- Add market data service for price updates (b460572)
- Separate price store from portfolio state (09f176f)
- Add price source boundary for execution planning (63b091a)
- Add target exposure planning for execution (abd2666)
- Add portfolio sync service for authoritative refresh (eb60dfd)
- Implement core binance exchange adapter (1004f55)
- Promote v1 modules to the crate root (66ef652)
- Split v1 close execution into planners (004ef56)
- Remove legacy code and keep v1 core only (9255542)
- Add v1 architecture skeleton and fake exchange core (21896a4)
- fix: harden backtest candle fetch retries and diagnostics (7a2e412)
- feat: add backtest candle fetch helper script (f56c158)
- fix(backtest): validate header columns before candle parsing (e9190c2)
- fix(backtest): validate csv header and emit clearer parse errors (d60d4fa)
- docs: add backtest CLI usage examples (b7c9787)
